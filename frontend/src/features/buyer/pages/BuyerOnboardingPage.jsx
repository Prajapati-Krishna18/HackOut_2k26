...
export const BuyerOnboardingPage = () => {
  ...
  // Completion calculation (80% default matching mockup)
  ...
  const handleSaveAll = () => {
    ...
    showToast('Buyer profile settings saved!');
  };
    ...
    <div className="min-h-screen w-full bg-[#f8fafc] font-sans text-slate-800 selection:bg-[#10b981] selection:text-white flex flex-col">
      ...
      <header className="w-full bg-white border-b border-slate-200/80 px-4 sm:px-8 py-2.5 flex items-center justify-between sticky top-0 z-50 shadow-xs">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            <Link to="/buyer/dashboard" className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-600 hover:text-[#0e6245] hover:bg-slate-50 rounded-lg transition-colors">
              <LayoutDashboard className="w-3.5 h-3.5" />
              <span>Dashboard</span>
            </Link>
            <Link to="/search" className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-600 hover:text-[#0e6245] hover:bg-slate-50 rounded-lg transition-colors">
            ...
            <Link to="/transactions" className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-600 hover:text-[#0e6245] hover:bg-slate-50 rounded-lg transition-colors">
              <BarChart3 className="w-3.5 h-3.5" />
              <span>Transactions</span>
            </Link>
            <Link to="/sustainability" className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-600 hover:text-[#0e6245] hover:bg-slate-50 rounded-lg transition-colors">
              <FileText className="w-3.5 h-3.5" />
              <span>Reports</span>
            </Link>
            <Link to="/notifications" className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-600 hover:text-[#0e6245] hover:bg-slate-50 rounded-lg transition-colors">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2.5 pl-2 border-l border-slate-200">
            <div className="w-8 h-8 rounded-full bg-[#0a4833] text-white flex items-center justify-center font-bold text-xs shadow-xs overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 pt-4 pb-2">
        ...
        >
          ...
          <div className="hidden md:flex flex-col items-center justify-center text-center rotate-[-6deg] select-none pointer-events-none opacity-85 z-10 mr-auto ml-12">
            <span className="font-serif italic text-lg sm:text-xl font-black text-[#0a4833] tracking-wider drop-shadow-sm">Cleaner</span>
            <span className="font-serif italic text-lg sm:text-xl font-black text-[#0e6245] tracking-wider drop-shadow-sm -mt-1">Choices</span>
            <span className="font-serif italic text-lg sm:text-xl font-black text-[#10b981] tracking-wider drop-shadow-sm -mt-1">Brighter</span>
            <span className="font-serif italic text-lg sm:text-xl font-black text-[#047857] tracking-wider drop-shadow-sm -mt-1">Tomorrows</span>
          </div>
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-8 py-4 flex-1">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs flex flex-col justify-between min-h-[580px]">
              <div className="space-y-5">
                ...
                <div className="flex flex-col items-center text-center space-y-2.5 pt-2">
                  ...
                  <div>
                    <h2 className="text-sm sm:text-base font-bold text-slate-900">{personalInfo.fullName}</h2>
                    <p className="text-xs text-slate-500 font-medium">{personalInfo.role}</p>
                  </div>
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          setActiveTab(tab.id);
                          if (tab.id !== 'profile') showToast(`Viewing ${tab.label}`);
                        }}
                        className={`w-full flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl text-xs font-semibold transition-all cursor-pointer ${isActive
            ...
            <section className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-xs sm:text-sm font-bold text-slate-900">Personal Information</h3>
                    <p className="text-[11px] text-slate-500">Update your personal details here.</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-1.5 rounded-xl border text-xs outline-none transition-all ${isEditingPersonal ? 'bg-white border-[#0e6245] ring-2 ring-emerald-50 text-slate-900 font-medium' : 'bg-slate-50/70 border-slate-200 text-slate-700 font-medium'
                      }`}
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full pl-8 pr-3 py-1.5 rounded-xl border text-xs outline-none transition-all ${isEditingPersonal ? 'bg-white border-[#0e6245] ring-2 ring-emerald-50 text-slate-900 font-medium' : 'bg-slate-50/70 border-slate-200 text-slate-700 font-medium'
                        }`}
                    />
            ...
            <section className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-xs sm:text-sm font-bold text-slate-900">Organization Details</h3>
                    <p className="text-[11px] text-slate-500">Tell us about your organization.</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-1.5 rounded-xl border text-xs outline-none transition-all ${isEditingOrg ? 'bg-white border-[#0e6245] ring-2 ring-emerald-50 text-slate-900 font-medium' : 'bg-slate-50/70 border-slate-200 text-slate-700 font-medium'
                        }`}
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-1.5 rounded-xl border text-xs outline-none transition-all ${isEditingOrg ? 'bg-white border-[#0e6245] text-slate-900 font-medium' : 'bg-slate-50/70 border-slate-200 text-slate-700 font-medium'
                        }`}
                    >
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`w-full pl-8 pr-3 py-1.5 rounded-xl border text-xs outline-none transition-all ${isEditingOrg ? 'bg-white border-[#0e6245] ring-2 ring-emerald-50 text-slate-900 font-medium' : 'bg-slate-50/70 border-slate-200 text-slate-700 font-medium'
                          }`}
                      />
            ...
            <section className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs space-y-4">
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-xs sm:text-sm font-bold text-slate-900">Preferences</h3>
                    <p className="text-[11px] text-slate-500">Set your preferences for a better experience.</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-1 items-start">
                <div className="space-y-1.5">
                  <label className="block text-[11px] font-semibold text-slate-700">Interested Project Types</label>
                    ...
                    {allProjectTypes.map((type) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-2.5 py-1 rounded-md text-[10px] font-medium transition-all cursor-pointer ${isSelected ? 'bg-slate-100 text-slate-800 border border-slate-300 font-semibold' : 'bg-white text-slate-500 border border-slate-200 hover:bg-slate-50'
                            }`}
                        >
                          {type}
                        </button>
                ...
                <div className="space-y-1.5">
                  <label className="block text-[11px] font-semibold text-slate-700">Preferred Regions</label>
                  <div className="flex flex-wrap gap-1.5">
                    {allRegions.map((reg) => {
                ...
                <div className="space-y-1.5">
                  <label className="block text-[11px] font-semibold text-slate-700">Communication Preferences</label>
          ...
          {/* COLUMN 3: RIGHT PROFILE COMPLETION GAUGE */}
          <aside className="lg:col-span-3 space-y-4">
            <div className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-xs space-y-5">
              <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                ...
                <h3 className="text-xs sm:text-sm font-bold text-slate-900">Profile Completion</h3>
              </div>
              ...
              <div className="flex flex-col items-center justify-center space-y-2 pt-1">
                <div className="relative w-28 h-28 flex items-center justify-center">
                  ...
                  <div className="absolute flex flex-col items-center justify-center">
                    <span className="text-2xl font-black text-slate-900 tracking-tight">{completionPercentage}%</span>
                  </div>
                </div>
              ...
              <div className="space-y-2.5 pt-2 border-t border-slate-100 text-xs">
                ...
                >
                  <div className={`w-4 h-4 rounded-full flex items-center justify-center shrink-0 ${hasAvatar || personalInfo.avatarUrl ? 'bg-emerald-700 text-white' : 'border border-slate-300'
                    }`}>
                    {hasAvatar || personalInfo.avatarUrl ? <Check className="w-2.5 h-2.5 stroke-[3]" /> : null}
                  </div>
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2.5 text-slate-600 hover:text-slate-900 text-left cursor-pointer group"
                >
                  <div className={`w-4 h-4 rounded-full flex items-center justify-center shrink-0 ${isEmailVerified ? 'bg-emerald-700 text-white' : 'border border-slate-300'
                    }`}>
                    {isEmailVerified ? <Check className="w-2.5 h-2.5 stroke-[3]" /> : null}
                  </div>
