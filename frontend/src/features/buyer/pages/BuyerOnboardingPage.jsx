                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-1.5 rounded-xl border text-xs outline-none transition-all ${
                      isEditingPersonal ? 'bg-white border-[#0e6245] ring-2 ring-emerald-50 text-slate-900 font-medium' : 'bg-slate-50/70 border-slate-200 text-slate-700 font-medium'
                    }`}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-1.5 rounded-xl border text-xs outline-none transition-all ${
                        isEditingOrg ? 'bg-white border-[#0e6245] ring-2 ring-emerald-50 text-slate-900 font-medium' : 'bg-slate-50/70 border-slate-200 text-slate-700 font-medium'
                      }`}
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className={`w-full px-3 py-1.5 rounded-xl border text-xs outline-none transition-all ${
                        isEditingOrg ? 'bg-white border-[#0e6245] text-slate-900 font-medium' : 'bg-slate-50/70 border-slate-200 text-slate-700 font-medium'
                      }`}
                    >
                      ...
                      return (
                        <button
                          ...
                          className={`px-2.5 py-1 rounded-md text-[10px] font-medium transition-all cursor-pointer ${
                            isSelected ? 'bg-slate-100 text-slate-800 border border-slate-300 font-semibold' : 'bg-white text-slate-500 border border-slate-200 hover:bg-slate-50'
                          }`}
                        >
                          {type}
                        </button>
